...
namespace FSkeletalMeshProcessor_AutoSet_Internal
{
	...
	class FAssetsProcessorFormSelection_UStaticMesh_PrintName;
	class FSkeletalMeshProcessor_AbcClothBindToMatSlots;
	class FAssetsProcessorFormSelection_UStaticMesh_SetMeshHighPrecision;
	class FAssetsProcessorFormSelection_UStaticMesh_SetMeshDF;
	class FAssetsProcessorFormSelection_UStaticMesh_RemoveDF;
	class FAssetsProcessorFormSelection_UStaticMesh_AutoBindMat;
