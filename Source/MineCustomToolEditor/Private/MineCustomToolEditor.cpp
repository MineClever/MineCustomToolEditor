...
#include "UserCommand/MineCustomToolCommands.hpp"
...
{
    // Add user console command
    ModuleListeners.Emplace (MakeShareable(new MineCustomToolCommands::UserCommandsRegister));
